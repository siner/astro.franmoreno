export const RESUME_DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      techStack: ['Productivity', 'GTD', 'Notion', 'Todoist'],
      description:
        'Kit completo para implementar GTD de forma profesional con guía PDF, template de Notion y script de automatización.',
      link: {
