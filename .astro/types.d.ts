...
declare module 'astro:content' {
	...
	type ContentEntryMap = {
		"blog": {
"comenzando-custom-post-types-wordpress.md": {
	id: "comenzando-custom-post-types-wordpress.md";
  slug: "comenzando-custom-post-types-wordpress";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"gestionar-vida-notion-metodologia-gtd.md": {
	id: "gestionar-vida-notion-metodologia-gtd.md";
...
"web-development-technologies-learn-2021.md": {
	id: "web-development-technologies-learn-2021.md";
  slug: "web-development-technologies-learn-2021";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
